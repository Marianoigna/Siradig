...
MODELOS_CANDIDATOS = [
    "gemini-3.6-flash",         # Modelo actual recomendado por Google
    "gemini-3.5-flash-lite",   # Modelo recomendado alternativo
    "gemini-3.5-flash",        # Flash completo (si existe en v1beta)
]
