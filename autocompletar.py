...
async def autocompletar_siradig():
    ...
    async with async_playwright() as p:
        try:
            ...
            # Asegurar que está en verGastosMedicos
            if "verGastosMedicos" not in page.url:
                print("No está en verGastosMedicos. Asegúrate de haber hecho paso 4.")
                return
